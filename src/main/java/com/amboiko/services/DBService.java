...
public class DBService {
    ...
    private static final String DB_HOST = "jdbc:mysql://localhost:8889/hw_14_web";
    ...
    private static final String GET_USER = "SELECT id, user_name FROM users WHERE email= ? AND password= ?";
    private static final String GET_USER_BY_ID = "SELECT id, user_name FROM users WHERE id=?";
    private static final String INSERT_USER = "INSERT INTO users (email, password, user_name) VALUES(?, ?, ?)";
    ...
    public User getUser(String email, String password) {
        ...
        try (Connection connection = getConnection()) {
            ...
            if (resultSet.next()) {
                user = new User().setFullName(resultSet.getString("user_name"));
            }
            resultSet.close();
