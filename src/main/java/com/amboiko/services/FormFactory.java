...
public class FormFactory {
    ...
    private static String getSelectOptions(String field, String[] fields) {
        ...
        for (String item : fields) {
            builder.append("<option").append(Validators.checkSelectedRegion(field, item)).append(" value='").append(item).append("'>").append(item).append("</option>");
        }
    ...
    public static String getRadioOptions(String fieldName, String field, String[] fields) {
        ...
        for (String item : fields) {
            builder.append("<label> ").append(item).append(" <input").append(Validators.isChecked(field, item)).append(" type='radio' value='").append(item).append("' name='").append(fieldName).append("' required/></label>");
        }
